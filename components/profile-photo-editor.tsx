...
export function ProfilePhotoEditor({currentPhoto,name}:{currentPhoto:string|null;name:string}){
  ...
  function choose(file:File|undefined){
    if(!file)return;if(!(file.type.startsWith("image/")||/\.(heic|heif|jpe?g|png|webp)$/i.test(file.name))||file.size>20_000_000){setMessage("Kies een foto tot 20 MB.");return}
